...
#### Considered Ideas / Categories / Topics
- Stats (Being able to see the stats of the last x days)
- Levelup system / Stats (in case I want to connect RPG elements into the plugin)
- Learning (as I currently need that)

### Final Interfaces
- Task Manager
- Current Focus
- Search Bar at the top, being able to search for notes containing tags, names, or just some sort of ocr
...
## QuickNote
A Button in the Home page, Clicking it will open a Text input & A Naming thing , to make it possible to instantly write down a Note. Pressing "save" will Save the note with the Name in the nameing thing into a specific folder
Quick Notes can then be looked at in the category managers category "Quick Note"
